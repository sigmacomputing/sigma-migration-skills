...
Rules live in the customer's HOME (`~/.qlik-to-sigma/learned-rules.yaml` or
...
def home_dir(home=None, env=None):
    ...
    return os.path.expanduser("~/.qlik-to-sigma")

def load(home=None, env="QLIK_TO_SIGMA_HOME"):
